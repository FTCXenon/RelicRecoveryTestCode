...
@TeleOp(name = "DirectScaleV2")
public class DirectScaleV2 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            RF.setPower((posRF / maxValue)/1.5);
            LF.setPower((posLF / maxValue)/1.5);
            RB.setPower((posRB / maxValue)/1.5);
            LB.setPower((posLB / maxValue)/1.5);
            ...
            while (gamepad1.right_stick_x > 0) {
                ...
                LF.setPower(motorPower/1.8);
                RF.setPower(-motorPower/1.8);
                LB.setPower(motorPower/1.8);
                RB.setPower(-motorPower/1.8);
            }
            //Counter-Clockwise
            while (gamepad1.right_stick_x < 0) {
                motorPower = Math.abs(gamepad1.right_stick_x);
