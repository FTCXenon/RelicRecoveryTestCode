...
@TeleOp(name = "DirectScaleV1")
public class DirectScaleV1 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while (gamepad1.right_stick_x > 0) {
                ...
                LF.setPower(motorPower/1.5);
                RF.setPower(-motorPower/1.5);
                LB.setPower(motorPower/1.5);
                RB.setPower(-motorPower/1.5);
            }
            //Counter-Clockwise
            while (gamepad1.right_stick_x < 0) {
                motorPower = Math.abs(gamepad1.right_stick_x);
